...
public abstract class AbstractInitialization extends Tree {
    ...
    public abstract void codeGenInit(DAddr addr, DecacCompiler comp, Type t);

    public abstract void codeGenInitField(int index, DecacCompiler comp, Type t);

    public abstract void codeGenInitTab(DecacCompiler compiler, Type t);
}
